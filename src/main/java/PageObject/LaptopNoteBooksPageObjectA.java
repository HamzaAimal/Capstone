...
public class LaptopNoteBooksPageObjectA extends Base{
	public void LaptopNoteBooksPageObject() {
	...
	private static WebElement compareMacBookAirIcon;
	
	@FindBy(xpath = "(//a[text()='MacBook Air'])[1]")
	private static WebElement compareSuccsessMessage;
	
	@FindBy(xpath = "//a[text()='product comparison']")
	private static WebElement comparisonLink;
	
	@FindBy(xpath = "//div/h1[text()='Product Comparison']")
	private static WebElement productComparisonChart;
	...
	public void clickOnAddToCartButton() {
		...
		public static void clickOnCompareMacBookAir() {
			compareMacBookAirIcon.click();
		}
		
		public static String successMessageCompare() {
			String actualResult = "Success: You have added " + compareSuccsessMessage.getText() + " to your product comparison!";
			return actualResult;
		}

		public static boolean isCompareSuccessMessagePresent() {
		...
		public static void clickOnComparisonLink() {
			comparisonLink.click();
		}
		
		public static String comparisonTableName() {
			String actualResult = productComparisonChart.getText();
			return actualResult;
		}
	
		
		public static boolean isCompareTablePresent() {
